...
const Journal = () => {
    ...
    return (
        <div className="journal-container">
            <div className="tabs">
                <button className={activeTab === 'journal' ? 'active' : ''}
                        onClick={() => setActiveTab('journal')}>Journal Entry
                </button>
                <button className={activeTab === 'chart' ? 'active' : ''} onClick={() => setActiveTab('chart')}>Mood
                    Chart
                </button>
                <button className={activeTab === 'entries' ? 'active' : ''} onClick={() => setActiveTab('entries')}>Past
                    Entries
                </button>
            </div>
